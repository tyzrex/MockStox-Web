      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center mb-10">
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            Experience the power of our AI model in predicting stock trends.
                ...
                {prediction ? (
                  <>
                    <h3 className="text-lg font-semibold mb-2">
                      AI Prediction for {stock.toUpperCase()}
                    </h3>
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      This is a simulated prediction. Real AI models analyze
                      vast amounts of data to make forecasts.
                    </p>
                  </>
                ) : (
                  <p className="text-gray-500">
                    Enter a stock symbol and click &apos;Predict&apos; to see
                    the AI forecast.
                  </p>
                )}
              </CardContent>
